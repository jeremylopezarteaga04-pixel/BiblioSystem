  ...
  <div class="app-shell">
    <aside class="sidebar" id="sidebar">
      ...
      <nav class="navigation" aria-label="Navegación principal">
        ...
        <a href="#usuarios" class="nav-link" data-view="usuarios"><span>♙</span> Lectores</a>
        <a href="#prestamos" class="nav-link" data-view="prestamos"><span>⇄</span> Préstamos <i id="nav-loans">0</i></a>
      </nav>
      <div class="sidebar-caption">ORGANIZACIÓN</div>
      <nav class="navigation" aria-label="Organización y reportes">
        <a href="#categorias" class="nav-link" data-view="categorias"><span>◈</span> Categorías y autores</a>
        <a href="#reportes" class="nav-link" data-view="reportes"><span>◷</span> Reportes</a>
